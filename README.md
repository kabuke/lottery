...
3. 每人只能中獎一次
4. 追加獎項及數量設定
5. 追加獎項抽獎人數設定, 可選 2. 全部不論是否中過獎或是未中獎人數
6. 即時巳抽獎項及中獎人列表
...
[特規] 萬一不幸設備重啟，在六個小時內，可以使用[使用者/公司名稱]以及[臨時密碼]登入，取回原本設定及中獎的資料。
[注意] 請注意 6 小時後 或 重啟後，所有設定及中獎的資料都會被清除。
...
使用流程如下:
1.輸入 [使用者/公司名稱]以及[臨時密碼]登入，沒有登入無法使用其他功能
